...
org.cometd.CometD = function(name)
{
    ...
    /**
     * Removes the subscription obtained with a call to {@link #listen(string, object, function)}.
     * @param subscription the subscription to unsubscribe.
     * @see #listen(channel, scope, callback)
     */
    ...
    /**
     * Removes all listeners registered with {@link #listen(channel, scope, callback)} or
     ...
     * but does not remove the listeners added via {@link listen(channel, scope, callback)}.
     */
